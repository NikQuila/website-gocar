  ...
  return (
    <Modal
      ...
      classNames={{
        ...
        body: 'dark:bg-dark-bg p-4 sm:p-6 overflow-y-auto',
        footer:
          'border-t border-gray-200 dark:border-gray-700 p-4 rounded-b-2xl sticky bottom-0 z-10 bg-white dark:bg-dark-bg',
