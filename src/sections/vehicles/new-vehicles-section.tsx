      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
        <div className='flex flex-col md:flex-row gap-10'>
          ...
          <div className='flex-1 min-w-0'>
            ...
            <div
              className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 bg-gray-50 dark:bg-dark-bg py-2 px-4 -mx-4 sm:px-0 sm:mx-0 rounded-lg z-10'
              style={{ position: 'sticky', top: 'var(--navbar-height)' }}
            >
